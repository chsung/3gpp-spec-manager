...
CONFIG_KEY_RUN_ON_STARTUP = "run_on_startup"
    ...
    for current_root, _, file_names in os.walk(folder_path):
        for file_name in file_names:
            ...
            if not file_name.lower().endswith(('.doc', '.docx')):
                continue
            word_files.append(os.path.join(current_root, file_name))
            ...
            try:
                ...
                if latest_file_exists:
                    ...
                    if num_top_level_items == 0:
                        ...
                        q.put({'type': 'ftp_log', 'level': 'ERROR', 'spec': spec_number, 'message': f"{operational_outcome_english}"})
